...
REQUIRED_TAXONOMY_COLUMNS = {
    ...
    "Prompt_Instructions": ["instruction_type", "instruction"],
}
...
ALLOWED_ENUMS = {
    "emerging_issue_relevance": ["yes", "no", "unclear"],
...
- flagging emerging issues only when the complaint suggests a broader pattern or new trend
"""
...
def build_output_schema() -> dict[str, Any]:
    item_properties: dict[str, Any] = {
        ...
        "subcategory": {
            "type": "string",
            "description": "A concise subcategory label. Use 'unclear' if needed.",
        },
        "root_cause": {"type": "string"},
        "emerging_issue_relevance": {
            "type": "string",
            "enum": ALLOWED_ENUMS["emerging_issue_relevance"],
        },
        "severity": {
            "type": "string",
